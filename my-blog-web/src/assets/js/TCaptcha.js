!function (t) {
  ...
  var o = function (t) {
    ...
    try {
      ...
      try {
        var e = document.URL, n = e.indexOf("?");
  ...
  "use strict";
  var r = Object.prototype.hasOwnProperty, o = Object.prototype.toString, a = Object.defineProperty,
    i = Object.getOwnPropertyDescriptor, c = function (t) {
  ...
  t.exports = function f() {
    var t, e, n, r, o, a, i = arguments[0], l = 1, d = arguments.length, h = !1;
    for ("boolean" == typeof i && (h = i, i = arguments[1] || {}, l = 2), (null == i || "object" != typeof i && "function" != typeof i) && (i = {}); l < d; ++l) if (null != (t = arguments[l])) for (e in t) n = p(i, e), i !== (r = p(t, e)) && (h && r && (s(r) || (o = c(r))) ? (o ? (o = !1, a = n && c(n) ? n : []) : a = n && s(n) ? n : {}, u(i, {
      name: e,
      newValue: f(h, a, r)
  ...
  var r, o, a = n(0), i = {
    ...
    s = (r = document.referrer, o = location.href || document.URL, r = r.length > 512 ? r.substr(0, 512) : r, o = o.length > 1024 ? o.substr(0, 1024) : o, ["referer=" + encodeURIComponent(r), "href=" + encodeURIComponent(o)].join("&"));
  t.exports = {
    type: i, send: function (t, e, n) {
      try {
  ...
  function u(t) {
    for (var e = [], n = {}, r = 0; r < t.length; r++) {
      var o = t[r], a = o[0], i = {css: o[1], media: o[2], sourceMap: o[3]};
  ...
  function f() {
    var t = document.createElement("style"), e = a();
  ...
  function l(t, e) {
    ...
    } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (s = document.createElement("link"), u = a(), s.rel = "stylesheet", u.appendChild(s), r = p(m, null, n = s), o = function () {
      n.parentNode.removeChild(n), n.href && URL.revokeObjectURL(n.href)
    }) : (n = f(), r = p(b, null, n), o = function () {
  ...
  var d, h = (d = [], function (t, e) {
    var n = [];
    d[t] = e;
    for (var r = 0; r < d.length; r++) d[r] && n.push(d[r]);
    return n.join("\n")
  });
  ...
  function m(t, e) {
    ...
    var o = new Blob([n], {type: "text/css"}), a = t.href;
  ...
  "object" !== ("undefined" == typeof JSON ? "undefined" : _typeof(JSON)) && (JSON = {}), function () {
    ...
    function str(t, e) {
      ...
      switch (s && "object" === (void 0 === s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), void 0 === s ? "undefined" : _typeof(s)) {
        ...
        case"object":
          if (!s) return "null";
          if (gap += indent, i = [], "[object Array]" === Object.prototype.toString.apply(s)) {
            for (a = s.length, n = 0; n < a; n += 1) i[n] = str(n, s) || "null";
            return o = 0 === i.length ? "[]" : gap ? "[\n" + gap + i.join(",\n" + gap) + "\n" + c + "]" : "[" + i.join(",") + "]", gap = c, o
          }
          if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep))) for (a = rep.length, n = 0; n < a; n += 1) "string" == typeof rep[n] && (o = str(r = rep[n], s)) && i.push(quote(r) + (gap ? ": " : ":") + o); else for (r in s) Object.prototype.hasOwnProperty.call(s, r) && (o = str(r, s)) && i.push(quote(r) + (gap ? ": " : ":") + o);
          return o = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + c + "}" : "{" + i.join(",") + "}", gap = c, o
      }
    }
  ...
  var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
    ...
    return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
  }, o = "[CODE_VERIFY]", a = "postMessage" in window;

  function i(t, e, n) {
    var o = "";
    if (arguments.length < 2 ? o = "[Msger] error 1" : "object" != (void 0 === t ? "undefined" : r(t)) ? o = "[Msger] error 2" : "string" != typeof e && (o = "[Msger] error 3"), o) throw new Error(o);
    this.target = t, this.name = e, this.domain = n || "*"
  }

  function c(t, e) {
    this.targets = {}, this.name = t, this.listenFunc = [], "string" != typeof (o = e || o) && (o = o.toString()), this.initListen()
  }
  ...
  var Messenger = __webpack_require__(9), domReady = __webpack_require__(19),
    btoa = window.btoa || __webpack_require__(20), extend = Object.assign || __webpack_require__(2),
    loadScript = __webpack_require__(21), eventListener = __webpack_require__(5), Executor = __webpack_require__(22),
    isIEVar = __webpack_require__(23), isElement = __webpack_require__(24), invisibleIframe = __webpack_require__(25),
    getScriptDomain = __webpack_require__(26), scriptDomain = getScriptDomain() || "",
  ...
  var grayscaleFrameJs = "/tcaptcha-frame.a62693b0.js", grayscaleThreshold = 1,
    grayscaleAppId = ["123", "2100049389", "2100049390", "2046103261", "2070173641", "2060075756"],
    grayscaleProb = Math.random(), needGrayscaleJs = void 0, jsLoadStatus = "none", capError = __webpack_require__(3),
    preVerifyData = {}, capObj = void 0, initQueue = [], defaultOpt = {
      type: "popup",
  ...
  t.exports = function (t) {
    var e, n = [], r = document, o = r.documentElement, a = o.doScroll,
  ...
  "use strict";
  var r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = function (t) {
  ...
  t.exports = function o(t, e, n, a, i, c, s) {
    ...
    function f(t) {
      u || (t && "load" === t.type || /^(loaded|complete)$/.test(this.readyState)) && (a() ? (u = !0, i && i()) : l())
    }
  ...
  t.exports = function () {
    try {
      ...
      if (!t) return "";
      var e = t.src, n = o(e).domain;
      if (n) return n;
      var i = /(https?\:\/\/[0-9a-zA-Z-:\.]+)\//i, c = e.match(i) || r().match(i);
      return c ? c[1] : ""
    } catch (s) {
      return ""
    }
